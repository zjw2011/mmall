package com.arunqi.mmall.server.leaf.dao;
 ...
 */
@Repository
public class LeafSegmentDao extends BaseJdbcDao {

    private static final String DATABASE_NAME = "orders";
    private static final String TABLE_NAME = "leaf_segment";
    private static final String COLUMNS =
            "id,biz_tag,max_id,step,load_factor,data_status,createtime,updatetime,rowversion";
